...
public final class Launcher extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        LOG.info("Laoxu Minecraft Launcher Version: " + Metadata.VERSION);
        ...
        try {
            ...
            Platform.runLater(() -> {
                ...
                // ========== 设置窗口标题为 Laoxu Minecraft Launcher ==========
    ...
    private static ButtonType showAlert(AlertType alertType, String contentText, ButtonType... buttons) {
        ...
        alert.setTitle(Metadata.FULL_TITLE);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LOG.info("Laoxu Global Directory: " + Metadata.HMCL_GLOBAL_DIRECTORY);
            LOG.info("Laoxu Current Directory: " + Metadata.HMCL_CURRENT_DIRECTORY);
            LOG.info("Laoxu Jar Path: " + Lang.requireNonNullElse(JarUtils.thisJarPath(), "Not Found"));
            LOG.info("Laoxu Log File: " + Lang.requireNonNullElse(LOG.getLogFile(), "In Memory"));
    ...
    public static void stopWithoutPlatform() {
        LOG.info("Stopping Laoxu Minecraft Launcher without JavaFX Toolkit.\n" + StringUtils.getStackTrace(Thread.currentThread().getStackTrace()));
